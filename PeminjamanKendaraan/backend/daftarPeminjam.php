...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="starter.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">BOOKING LIST</span>
    </a>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="tambahKendaraan.php" class="btn btn-success" style="margin-bottom: 5px;">Add Vehicle</a>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>Diana Walters</td>
                    <td>087365473823</td>
                    <td>diana.walters@carriers.id</td>
                    <td>Company</td>
                    <td>
                  ...
                  <tr>
                    <td>Wendy Carmilles</td>
                    <td>Wendy Carmilles</td>
                    <td>087365473894</td>
                    <td>Wendy.Carmille@gamil.id</td>
                    <td>Person</td>
                    <td>
                      <a href="#" class="btn btn-primary">Detail</a>
                      <a href="#" class="btn btn-warning">Edit</a>
